      ...
      >
        <div className="container">
          ...
          <div className="overview">
            ...
            <p className="text-dark mb-2">
              ...
              forms a majority across the nation, the simulation allows them to
              polish their critical skills in the areas of public speaking,
              diplomacy, negotiation, team strategy building and more.
            </p>
            <p className="text-dark mb-2">
              Moreover, model G20 is apt for young leaders of tomorrow who wish
              to be the drivers of change.
            </p>
            <p className="text-dark mb-2">
              The summit offers youngsters a plethora of opportunities to learn,
              discuss, and act with powerful speakers, learned panellists, and
              skilled professionals on the most burning global issues
            </p>
          </div>
          <hr className="my-4" />
          {/* <!-- Three Tracks  --> */}
          <div className="three-tracks">
            ...
            <p className="text-dark mb-2">
              ...
              separately wherein they discuss and negotiate matters of economic
            ...
            <p className="text-dark mb-2">
              Remember, the objective of these model track meetings is to ideate
              and discuss pressing issues that can be included in the
                  ...
                  <div className="row align-items-center">
                    <div className="col-12 col-lg-4">
                      ...
                      <h6 className="fs-5 fw-light text-lowercase">
                        ...
                        participants from all tracks come together to re-create
                        an actual G20 Leaders Summit and form a consensus
                        portfolio
                      </h6>
                    </div>
                    <div className="col-12 col-lg-8">
        ...
        <div className="container">
          ...
          <div className="overview">
            ...
            <p className="text-dark mb-2">
              For the Sherpa Track, we have a Sherpa and a Sous-Sherpa(deputy).
              For the Finance Track, we have the finance minister and Central
              Bank governor (deputy). The 6th and 7th delegates will act as the
              senior advisors to their teams in both tracks. All members of the
              delegation will be receiving certifications at the end of the
              model summit simulation
            </p>
          </div>
          <hr className="my-4" />
          {/* <!-- Delegation  --> */}
          <div className="overview">
            ...
            <ul className="ps-0 fs-6 text-dark">
              ...
              <li>
                <i className="bi bi-arrow-right text-primary me-2"></i>Best Head
                of Delegation
              </li>
              <li>
                <i className="bi bi-arrow-right text-primary me-2"></i>Best
          ...
          <div className="overview">
            ...
            <p className="text-dark mb-2">
              ...
              country, the participants will receive a memorable opportunity to
              explore the diverse food flavours and cultural heritage of India
              with an all-sponsored cultural night event. Many traditional
              shows, delectable cuisines, and network exchanges are planned by
              the Indian government for the delegates.
            </p>
            <p className="text-dark mb-2">
