...
const IndiaAchivements = () => {
  return (
    <div>
      <BreadCrumb heading={"Achievements of India"} />
      <div className="container py-5">
        <h3>Achievements of India</h3>
        <p>
          From being termed as the ‘IT Capital’ to launching ‘Mangalyaan’ into
          space. From having the busiest railway networks to the longest-written
          constitution, India surely has made a remarkable impact on the world.
        </p>
        <p>
          ...
          nations in 2022 and taking the theme of ‘Vasudhaiva Kutumbakam’ or the
          ‘World is One Family’ to glorious heights.
        </p>
        <p>
          Take a look at some of the fascinating facts and figures that reflect
          India’s pivotal achievements in various sectors and fields.
        </p>
        <h4 className="fs-2">Education</h4>
        <div className="list-group">
          <li className="list-group-item d-flex p-0 border-0">
            <i class="bi bi-arrow-right-circle-fill text-warning fs-4 me-2"></i>
            <p>
