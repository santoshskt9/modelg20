...
export default function StudentDataTable({ data, reload }) {
          ...
          {data.map((row, i) => {
            return (
              <tr key={i}>
                ...
                <td className="p-3">{row.instituteId}</td>
                ...
                <td className="p-3">{row.social_active}</td>
                <td className="p-3">{row.views_on_g20}</td>
                <td className="p-3">{row.topics}</td>
